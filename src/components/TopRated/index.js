...
const TopRated=()=>{
    const [topRatedMoviesArray,setTopRatedMovies]=useState([])
        ...
        const getAllMovies= async()=>{
            try{
                ...
                if(response.status===200){
                    ...
                    setTopRatedMovies(detailsArray)
    ...
    const renderApiSuccessView=()=>(
        ...
        <div className='main-container'>
            <ul className='ul-container'>
                {topRatedMoviesArray.map(eachItem=>(
            ...
            <div className='page-navigation-container'>
                ...
                {!topRatedMoviesArray.length<20 && <button onClick={onNextButton} className='page-buttons'>Next Page</button>}
            </div>
        </div>
    )
